...
public class VariousUsesOfStreamApi {

	public static final Person YOUNG_PERSON = new Person("Bianca", 1986);
	...
	public void filterWithPredicateAlt() {
		...
		assertThat(oldPersons, CoreMatchers.not(hasItem(YOUNG_PERSON)));
	}
	...
	public void mapWithFunctionJava8WithStreams() throws Exception {
		...
		List<String> names = persons.stream()
				...
				.collect(Collectors.toList());
		assertThat(names, hasItem("Sebastian"));
		assertThat(names, hasItem(is("Bianca")));
	}
